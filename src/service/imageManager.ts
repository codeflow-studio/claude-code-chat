...
export class ImageManager {
  ...
  constructor(private context: vscode.ExtensionContext) {
    ...
    this.tempDir = path.join(os.tmpdir(), 'claude-code-extension', this.sessionId);
  ...
  private validateImage(fileName: string, mimeType: string, base64Data: string): void {
    // Check file type
